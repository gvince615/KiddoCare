...
import com.vintek_ss.vince.kiddocare.DiscountData;
 ...
 */
public class DiscountDescTextWatcher implements TextWatcher {
    List<Object> cards;
    int position;
    Object card;
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ((DiscountData) card).discount_description = s.toString();
    }
