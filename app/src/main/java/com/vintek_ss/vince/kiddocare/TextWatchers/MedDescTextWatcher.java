...
import com.vintek_ss.vince.kiddocare.MedicationData;
 ...
 */
public class MedDescTextWatcher implements TextWatcher {
    List<Object> cards;
    int position;
    Object card;
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ((MedicationData) card).medication_description = s.toString();
    }
