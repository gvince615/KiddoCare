...
public class ChildData {
    ...
    public ChildData(int number, int pic, String first_name, String last_name, String birth_date,
    ...
    public ChildData(int number, int pic, String first_name, String last_name, String age_bracket) {
        this.number = number;
        this.pic = pic;
        this.first_name = first_name;
        this.last_name = last_name;
